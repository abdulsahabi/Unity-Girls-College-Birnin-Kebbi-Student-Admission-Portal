...
WHERE 
    c.id = ?;
";
  $statement = $pdo->prepare($getComplaint);
  ...
  $setView = "UPDATE complain SET isOpened = 1 WHERE id = ?";
  ...
  <main class="main-post">
    <div class="post-article">
      <div class="post-title">
        <?php echo htmlspecialchars_decode($row["nature"]); ?>
      </div>
      <div class="post-update">
       Issue on: <?php echo $date->format("d M, Y"); ?>
      </div>
      <div class="dir">
        <img src="../public/icons/user.png" alt="" class="icon">
        <div>
         From:   <?php echo htmlspecialchars_decode($row["fullname"]); ?>
        </div>
      </div>
