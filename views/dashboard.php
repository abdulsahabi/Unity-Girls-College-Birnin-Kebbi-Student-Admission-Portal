    ...
    <div id="contents">
      ...
      <div class="child-format personal-information" id="approved-list">
        ...
        <div class="student-profile">
          <div class="column-1">
            <img src="../public/uploads/<?php echo $user["display_image"]; ?>" class="std-img" alt="student profile">
          </div>
          <div class="column-2">
            ...
            <div class="admission-id">UNT/21/<?php echo $user["admission_no"]; ?></div>
          </div>
        </div>
        ...
        <div class="student-details">
          ...
          <div class="details-info">
            <div class="rows">
              ...
              <input type="text" value="<?php echo $user["phone_no"]; ?>" class="phone-number font-1" readOnly>

              <div class="title">Date of Birth: </div>
              <input type="text" class="dob font-1" value="<?php echo $user["dob"]; ?>" readOnly>
            ...
            <div class="rows">
              ...
              <div class="home-address font"><?php echo $user["address"]; ?></div>
              <div class="title">Local government: </div>
              <div class="font"><?php echo $user["localG"]; ?></div>
              <div class="title">State of origin: </div>
              <div class="state-origin font"><?php echo $user["state"]; ?></div>
              <div class="title">Nationality: </div>
              <div class="nationality font"><?php echo $user["nationality"]; ?></div>
            </div>
            <div class="rows">
              <div class="rows-title">
              ...
              <div class="previous-school font"><?php echo $user["previous_school"]; ?></div>
              <div class="title">Year of passing </div>
              <div class="year-of-passing font"><?php echo $user["year_of_passing"]; ?></div>
              <div class="title">Admission type:</div>
              <div class="admission-type font"><?php echo $user["admission_type"]; ?></div>
              <div class="title">Admission class: </div>
              <div class="admission-class font"><?php echo $user["admission_class"]; ?></div>
            </div>
          </div>
        </div>
      </div>
