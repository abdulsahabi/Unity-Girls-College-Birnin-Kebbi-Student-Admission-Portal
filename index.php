    ...
    <body>
        ...
        <div class="swiper-wrapper original-post">
          ...
          <div class="post swiper-slide">
            <img src="./public/uploads/<?php echo $row[
              "feature_img"
            ...
            <a class="post-title" href="/views/post.php?id=<?php echo $row[
              "post_id"
            ]; ?>">
        ...
        <footer>
            <div class="footer-wrapper">
                <div class="guidelines">
                    <div class="guide-title">GUIDELINES</div>
                    <a href="#">Privacy policy</a>
                    <a href="#">Terms & conditions</a>
                    <a href="#">Troubleshooting?</a>
                </div>
                <div class="guidelines">
                    <div class="guide-title">INFORMATION</div>
                    <a href="#">Contact Us</a>
                    <a href="#">About Us</a>
                </div>
            </div>
